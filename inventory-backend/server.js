...
/*
Перш ніж зберегти дані, у гру вступає проміжний обробник (middleware) під назвою multer.
multer бере отриманий файл і фізично зберігає його у папку uploads/ на сервері.
Файл успішно збережено - сервер формує публічне посилання на нього (наприклад, http://localhost:3000/uploads/фото.jpg).
(Саме це текстове посилання, а не сам файл, зберігається у наш масив інвентарю разом із назвою та описом.)
Після цього сервер повертає успішну відповідь
Фронтенд розуміє, що все пройшло добре, і перенаправляє користувача назад до таблиці інвентарю, 
де нова позиція вже відображається із завантаженим фото.
*/